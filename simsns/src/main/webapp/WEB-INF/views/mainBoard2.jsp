	...
	if(searchKind == 'post') {
		...
		$.ajax({
	        ...
	        success : function(data){
	            ...
	            location.href = '#' + data.result.postTimestamp + data.result.postNo;
	        }
	    });
		...
		$.ajax({
	        ...
	        success : function(data){
	            $("#search").html(JSON.stringify(data));
	        }
	    });
	}
}
...
<input type="text" id="searchKeyword"><input type="button" value="검색" onclick="search()">
<div id="searchResult">
	<input type="button" value="이전" onclick="searchPrevious">
	<span></span>
	<input type="button" value="다음" onclick="searchNext">
</div>
<br/>
