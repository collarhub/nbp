					...
					<div class="card-header">
						<div class="form-group">
							<div class="row">
								...
								<input class="col-10 form-control" id="postTitle" name="postTitle" type="text" placeholder="제목을 입력하세요" value="${postTitle}">
							</div>
							<div class="row">
								<form:errors path="postVO.postTitle" class="ml-2 text-danger"></form:errors>
							</div>
						</div>
					</div>
					<div class="card-body">
						<div class="form-group">
							<div class="row">
								...
								<textarea class="col-10 form-control post-write-content" rows="5" id="postContent" name="postContent" placeholder="내용을 입력하세요">${postContent}</textarea>
							</div>
							<div class="row">
								<form:errors path="postVO.postContent" class="ml-2 text-danger"></form:errors>
							</div>
						</div>
					</div>
