...
<head>
	...
	<script type="text/javascript">
		...
		$(document).ready(function() {
			if('${param.back}' == '') {
				$('#writeCancel').attr('href', 'picture');
				$('#writeBack').val('picture');
			}
...
<body class="fixed-nav sticky-footer bg-gray" id="page-top">
	...
	<div class="content-wrapper content-wrapper-simsns">
		...
		<div class="post-wrapper-simsns">
			<div class="mb-0 mt-4">
				<i class="fa fa-camera"></i> 사진 추가
			</div>
			<hr class="mt-2">
			<form action="writePictureCommit" method="post" enctype="multipart/form-data" id="formWrite">
				<div class="card card-register mx-auto mt-5">
					<div class="card-header">
						<div class="form-group">
							<div class="row">
								<label class="col-2" for="pictureTitle">제목</label>
								<input class="col-10 form-control" id="pictureTitle" name="pictureTitle" type="text" placeholder="제목을 입력하세요" value="${postTitle}">
							</div>
							<div class="row">
					...
					<div class="card-footer" style="background:white">
						<div class="form-group">
							<div class="row">
								...
								<form:errors path="pictureVO.picturePath" class="ml-2 text-danger"></form:errors>
							</div>
				...
				<input type="submit" class="mt-3 btn-center btn btn-primary btn-block bg-simsns" value="작성">
				<input type="hidden" id="writeBack" value="${param.back}" name="back">
				<div class="text-center">
					<a id="writeCancel" class="btn-center d-block small mt-3" href="${param.back}">취소</a>
				</div>
			</form>
		</div>
